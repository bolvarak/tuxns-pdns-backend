...
namespace TuxNS
{
	...
	class Listener : public QLocalServer
	{
		...
		signals:
			...
			/**
			 * @paragraph This signal fires when the local server has shutdown
			 * @brief TuxNS::Listener::hasShutdown()
			 * @return void
			 */
			void hasShutdown();
		...
		public slots:
			...
			/**
			 * @paragraph This slot handles the shutdown sequence for the server
			 * @brief TuxNS::Listener::shutdown()
			 * @return void
			 */
			void shutdown();
